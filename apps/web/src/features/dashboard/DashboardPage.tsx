    ...
    <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-3">
                <div className="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl bg-primary-600 shadow-sm">
              ...
              <p className="text-xs sm:text-sm text-text-secondary max-w-2xl leading-relaxed ml-[52px] sm:ml-14">
      ...
      {!isPremium && (
        <button
          ...
          className="w-full rounded-2xl border border-accent-400/30 bg-accent-50 dark:bg-accent-900/10 p-4 sm:p-6 text-left group hover:border-accent-400/50 hover:bg-accent-50 dark:hover:bg-accent-900/20 hover:shadow-md transition-all duration-200 active:scale-[0.99]"
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="flex h-11 w-11 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-accent-400 text-white shadow-sm shrink-0">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-secondary flex items-center gap-2">
                  <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-accent-500 shrink-0" />
                  <span className="line-clamp-2 sm:line-clamp-1">AI-powered CV rewriting, cover letter generation, interview prep & more</span>
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 text-sm font-bold text-accent-600 dark:text-accent-400 group-hover:gap-3 transition-all ml-14 sm:ml-0">
        ...
        {STAT_CARDS.map((c) => {
          ...
          return (
            <Card
              key={c.label}
              hover
              className="group cursor-pointer p-4 sm:p-6 border-0 shadow-md"
              onClick={() => navigate(c.link)}
            >
              <div className="flex items-center sm:items-start sm:flex-col gap-4 sm:gap-0">
                <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-primary-600 shadow-sm sm:mb-5 shrink-0">
                  <Icon className="h-4.5 w-4.5 sm:h-5 sm:w-5 text-white" />
                </div>
                <div className="flex-1 flex items-center justify-between sm:block">
                  <div>
                    <p className="text-sm font-semibold text-text-primary sm:hidden">
                      {c.label}
                    </p>
                    <p className="text-2xl sm:text-4xl font-bold text-text-primary tracking-tight sm:mb-1">
                      {value}
                    </p>
                    <p className="hidden sm:block text-sm font-semibold text-text-primary mb-0.5">
                      {c.label}
                    </p>
                  ...
                  <ArrowRight className="h-5 w-5 text-text-tertiary opacity-100 sm:opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                </div>
              </div>
            </Card>
          );
      ...
      <Card className="overflow-hidden border-0 shadow-md">
        <div className="flex items-center justify-between p-4 sm:p-6 pb-4 sm:pb-5 border-b border-border">
