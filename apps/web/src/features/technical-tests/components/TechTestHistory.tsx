    ...
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      {state.isLoadingTests ? (
        ...
        <div className="text-center py-20 space-y-3">
          <ClipboardCheck className="h-12 w-12 text-gray-300 dark:text-gray-700 mx-auto" />
...
function TestCard({
  ...
  return (
    <div className="group rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden hover:shadow-md transition-shadow">
      <div className="flex items-center gap-4 p-4">
        {/* Grade badge if evaluated */}
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            <span
              className={`text-[10px] font-medium px-1.5 py-0.5 rounded ${statusMeta.color}`}
            >
              {statusMeta.label}
            </span>
              ...
              <>
                ...
                <div className="flex gap-1 flex-wrap">
                  {test.tags.slice(0, 3).map((t) => (
                    <span
                      key={t}
                      className="text-[9px] font-medium bg-violet-50 dark:bg-violet-900/20 text-violet-500 dark:text-violet-400 px-1 py-0.5 rounded"
                    >
                      {t}
                    </span>
                  ))}
        ...
        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors"
          >
