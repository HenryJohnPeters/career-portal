  ...
  return (
    <div className="min-h-screen bg-bg-primary text-text-primary">
        ...
        <div className="max-w-6xl mx-auto w-full flex items-center justify-between px-5 sm:px-8">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-1.5 rounded-lg bg-amber-400 px-3.5 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-amber-500 transition-all duration-150 active:scale-95"
            >
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-bg-elevated px-3.5 py-1.5 text-xs font-semibold text-text-primary hover:bg-bg-tertiary transition-all duration-150 active:scale-95 shadow-sm"
            >
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center px-5 sm:px-8 pt-20 sm:pt-28 md:pt-36 pb-16 sm:pb-24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
            <Link
              to="/register"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-primary-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-primary-700 hover:shadow-md transition-all duration-150 active:scale-[0.97]"
            >
              Get Started Free <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
              to="/register?plan=premium"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-amber-400 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-amber-500 transition-all duration-150 active:scale-[0.97]"
            >
              <Crown className="h-4 w-4" />
              Try Premium <Sparkles className="h-3.5 w-3.5" />
            </Link>
            <a
              href="#features"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-bg-elevated px-6 py-3 text-sm font-semibold text-text-secondary hover:bg-bg-tertiary transition-all duration-150 shadow-sm"
            >
              Explore features
            </a>
          </div>
      ...
      <section className="border-y border-border bg-bg-secondary">
        <div className="max-w-4xl mx-auto px-5 sm:px-8 py-5 grid grid-cols-3 divide-x divide-border text-center">
          {stats.map(({ value, label }) => (
            <div key={label} className="px-4">
              <p className="text-2xl sm:text-3xl font-extrabold tracking-tight text-text-primary">
                {value}
              </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map(({ icon: Icon, title, free, premium }) => (
            <div
              key={title}
              className="group bg-bg-elevated border border-border rounded-2xl p-6 hover:border-primary-200 dark:hover:border-primary-800/60 hover:shadow-lg transition-all duration-200 flex flex-col"
            >
        ...
        <div className="relative overflow-hidden rounded-2xl bg-bg-elevated border border-border shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 px-8 sm:px-12 py-10 sm:py-12">
            ...
            <div className="flex flex-col gap-3 shrink-0 w-full sm:w-auto">
              <Link
                to="/register"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary-600 px-7 py-3 text-sm font-semibold text-white shadow-sm hover:bg-primary-700 hover:shadow-md transition-all duration-150 active:scale-[0.97]"
              >
                Get Started Free <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                to="/register?plan=premium"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-amber-300/60 dark:border-amber-700/40 bg-amber-50 dark:bg-amber-900/10 px-7 py-3 text-sm font-semibold text-amber-700 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/20 transition-all duration-150 active:scale-[0.97]"
              >
                <Crown className="h-4 w-4" />
